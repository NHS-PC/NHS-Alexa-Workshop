...
#    # Override the print function IF something occurs
    try:
        ...
        if finalPrediction < 25:
            ...
            if temp == 0:
                return question("There is a small chance of a snow day in {}, {}, because it isn't cold enough. Right now, it is about {} degrees outside, with a low of {} degrees for the day. Would you like to ask again?".format(city,state,tempc,temperature))

            if accumulation <= 2 and cat<=1:
                return question("There is a small chance of a snow day in {}, {}, because the forecast calls for {}, and less than an inch of snowfall in the next 6 hours. Would you like to ask again?".format(city,state,summary))
